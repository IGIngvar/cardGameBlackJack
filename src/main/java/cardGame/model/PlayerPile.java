...
public class PlayerPile implements Emptiable, Sized, Iterable<Card> {
    ...
    public void put(Card card) {
        ...
        case ACE:  this.setSum(this.getSum()+11);
        		   ...
        		   aces();
                 break;
        case TWO:  this.setSum(this.getSum()+2);aces();
                 break;
        case THREE: this.setSum(this.getSum()+3);aces();
                 break;
        case FOUR:  this.setSum(this.getSum()+4);aces();
                 break;
        case FIVE:  this.setSum(this.getSum()+5);aces();
                 break;
     ...
     */
    private class ConcretePlayerPileIterator implements Iterator<Card> {
         ...
         */
        public ConcretePlayerPileIterator() {
    ...
    public Iterator<Card> iterator() {
        return new ConcretePlayerPileIterator();
    }
